...
export function LottoReceipt({ lottoSets }: LottoReceiptProps) {
  ...
  return (
    <div className="bg-card border-2 border-dashed border-border rounded-sm shadow-lg overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* 헤더 */}
